...
@$core.Deprecated('Use roomMsgTypeEnumDescriptor instead')
const RoomMsgTypeEnum$json = {
  '1': 'RoomMsgTypeEnum',
  '2': [
    {'1': 'DEFAULTROOMMSG', '2': 0},
    {'1': 'ECOMLIVEREPLAYSAVEROOMMSG', '2': 1},
    {'1': 'CONSUMERRELATIONROOMMSG', '2': 2},
    {'1': 'JUMANJIDATAAUTHNOTIFYMSG', '2': 3},
    {'1': 'VSWELCOMEMSG', '2': 4},
    {'1': 'MINORREFUNDMSG', '2': 5},
    {'1': 'PAIDLIVEROOMNOTIFYANCHORMSG', '2': 6},
    {'1': 'HOSTTEAMSYSTEMMSG', '2': 7},
  ],
};

/// Descriptor for `RoomMsgTypeEnum`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List roomMsgTypeEnumDescriptor = $convert.base64Decode(
    'Cg9Sb29tTXNnVHlwZUVudW0SEgoOREVGQVVMVFJPT01NU0cQABIdChlFQ09NTElWRVJFUExBWV'
    'NBVkVST09NTVNHEAESGwoXQ09OU1VNRVJSRUxBVElPTlJPT01NU0cQAhIcChhKVU1BTkpJREFU'
    'QUFVVEhOT1RJRllNU0cQAxIQCgxWU1dFTENPTUVNU0cQBBISCg5NSU5PUlJFRlVORE1TRxAFEh'
    '8KG1BBSURMSVZFUk9PTU5PVElGWUFOQ0hPUk1TRxAGEhUKEUhPU1RURUFNU1lTVEVNTVNHEAc=');
...
@$core.Deprecated('Use emojiChatMessageDescriptor instead')
const EmojiChatMessage$json = {
  '1': 'EmojiChatMessage',
  '2': [
    {'1': 'common', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'common'},
    {'1': 'user', '3': 2, '4': 1, '5': 11, '6': '.douyin.User', '10': 'user'},
    {'1': 'emojiId', '3': 3, '4': 1, '5': 3, '10': 'emojiId'},
    {'1': 'emojiContent', '3': 4, '4': 1, '5': 11, '6': '.douyin.Text', '10': 'emojiContent'},
    {'1': 'defaultContent', '3': 5, '4': 1, '5': 9, '10': 'defaultContent'},
    {'1': 'backgroundImage', '3': 6, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'backgroundImage'},
    {'1': 'fromIntercom', '3': 7, '4': 1, '5': 8, '10': 'fromIntercom'},
    {'1': 'intercomHideUserCard', '3': 8, '4': 1, '5': 8, '10': 'intercomHideUserCard'},
  ],
};

/// Descriptor for `EmojiChatMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List emojiChatMessageDescriptor = $convert.base64Decode(
    'ChBFbW9qaUNoYXRNZXNzYWdlEiYKBmNvbW1vbhgBIAEoCzIOLmRvdXlpbi5Db21tb25SBmNvbW'
    '1vbhIgCgR1c2VyGAIgASgLMgwuZG91eWluLlVzZXJSBHVzZXISGAoHZW1vamlJZBgDIAEoA1IH'
    'ZW1vamlJZBIwCgxlbW9qaUNvbnRlbnQYBCABKAsyDC5kb3V5aW4uVGV4dFIMZW1vamlDb250ZW'
    '50EiYKDmRlZmF1bHRDb250ZW50GAUgASgJUg5kZWZhdWx0Q29udGVudBI3Cg9iYWNrZ3JvdW5k'
    'SW1hZ2UYBiABKAsyDS5kb3V5aW4uSW1hZ2VSD2JhY2tncm91bmRJbWFnZRIiCgxmcm9tSW50ZX'
    'Jjb20YByABKAhSDGZyb21JbnRlcmNvbRIyChRpbnRlcmNvbUhpZGVVc2VyQ2FyZBgIIAEoCFIU'
    'aW50ZXJjb21IaWRlVXNlckNhcmQ=');
...
const ChatMessage$json = {
  ...
  '2': [
    ...
    {'1': 'publicAreaCommon', '3': 9, '4': 1, '5': 11, '6': '.douyin.PublicAreaCommon', '10': 'publicAreaCommon'},
    {'1': 'giftImage', '3': 10, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'giftImage'},
...
final $typed_data.Uint8List chatMessageDescriptor = $convert.base64Decode(
    ...
    'QXJlYUNvbW1vbhgJIAEoCzIYLmRvdXlpbi5QdWJsaWNBcmVhQ29tbW9uUhBwdWJsaWNBcmVhQ2'
    '9tbW9uEisKCWdpZnRJbWFnZRgKIAEoCzINLmRvdXlpbi5JbWFnZVIJZ2lmdEltYWdlEh4KCmFn'
...
const User$json = {
  ...
  '2': [
    ...
    {'1': 'PayGrade', '3': 23, '4': 1, '5': 11, '6': '.douyin.PayGrade', '10': 'PayGrade'},
    {'1': 'FansClub', '3': 24, '4': 1, '5': 11, '6': '.douyin.FansClub', '10': 'FansClub'},
...
final $typed_data.Uint8List userDescriptor = $convert.base64Decode(
    ...
    'luLkZvbGxvd0luZm9SCkZvbGxvd0luZm8SLAoIUGF5R3JhZGUYFyABKAsyEC5kb3V5aW4uUGF5'
    'R3JhZGVSCFBheUdyYWRlEiwKCEZhbnNDbHViGBggASgLMhAuZG91eWluLkZhbnNDbHViUghGYW'
    '5zQ2x1YhIcCglTcGVjaWFsSWQYGiABKAlSCVNwZWNpYWxJZBIxCgxBdmF0YXJCb3JkZXIYGyAB'
    'KAsyDS5kb3V5aW4uSW1hZ2VSDEF2YXRhckJvcmRlchIjCgVNZWRhbBgcIAEoCzINLmRvdXlpbi'
    '5JbWFnZVIFTWVkYWwSOwoRUmVhbFRpbWVJY29uc0xpc3QYHSADKAsyDS5kb3V5aW4uSW1hZ2VS'
    'EVJlYWxUaW1lSWNvbnNMaXN0EhwKCWRpc3BsYXlJZBgmIAEoCVIJZGlzcGxheUlkEhYKBnNlY1'
    'VpZBguIAEoCVIGc2VjVWlkEicKDmZhblRpY2tldENvdW50GP4HIAEoBFIOZmFuVGlja2V0Q291'
    'bnQSFQoFaWRTdHIYhAggASgJUgVpZFN0chIbCghhZ2VSYW5nZRiVCCABKA1SCGFnZVJhbmdl');

@$core.Deprecated('Use payGradeDescriptor instead')
const PayGrade$json = {
  '1': 'PayGrade',
  '2': [
    {'1': 'totalDiamondCount', '3': 1, '4': 1, '5': 3, '10': 'totalDiamondCount'},
    {'1': 'diamondIcon', '3': 2, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'diamondIcon'},
    {'1': 'name', '3': 3, '4': 1, '5': 9, '10': 'name'},
    {'1': 'icon', '3': 4, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'icon'},
    {'1': 'nextName', '3': 5, '4': 1, '5': 9, '10': 'nextName'},
    {'1': 'level', '3': 6, '4': 1, '5': 3, '10': 'level'},
    {'1': 'nextIcon', '3': 7, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'nextIcon'},
    {'1': 'nextDiamond', '3': 8, '4': 1, '5': 3, '10': 'nextDiamond'},
    {'1': 'nowDiamond', '3': 9, '4': 1, '5': 3, '10': 'nowDiamond'},
    {'1': 'thisGradeMinDiamond', '3': 10, '4': 1, '5': 3, '10': 'thisGradeMinDiamond'},
    {'1': 'thisGradeMaxDiamond', '3': 11, '4': 1, '5': 3, '10': 'thisGradeMaxDiamond'},
    {'1': 'payDiamondBak', '3': 12, '4': 1, '5': 3, '10': 'payDiamondBak'},
    {'1': 'gradeDescribe', '3': 13, '4': 1, '5': 9, '10': 'gradeDescribe'},
    {'1': 'gradeIconList', '3': 14, '4': 3, '5': 11, '6': '.douyin.GradeIcon', '10': 'gradeIconList'},
    {'1': 'screenChatType', '3': 15, '4': 1, '5': 3, '10': 'screenChatType'},
    {'1': 'imIcon', '3': 16, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'imIcon'},
    {'1': 'imIconWithLevel', '3': 17, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'imIconWithLevel'},
    {'1': 'liveIcon', '3': 18, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'liveIcon'},
    {'1': 'newImIconWithLevel', '3': 19, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'newImIconWithLevel'},
    {'1': 'newLiveIcon', '3': 20, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'newLiveIcon'},
    {'1': 'upgradeNeedConsume', '3': 21, '4': 1, '5': 3, '10': 'upgradeNeedConsume'},
    {'1': 'nextPrivileges', '3': 22, '4': 1, '5': 9, '10': 'nextPrivileges'},
    {'1': 'background', '3': 23, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'background'},
    {'1': 'backgroundBack', '3': 24, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'backgroundBack'},
    {'1': 'score', '3': 25, '4': 1, '5': 3, '10': 'score'},
    {'1': 'buffInfo', '3': 26, '4': 1, '5': 11, '6': '.douyin.GradeBuffInfo', '10': 'buffInfo'},
    {'1': 'gradeBanner', '3': 1001, '4': 1, '5': 9, '10': 'gradeBanner'},
    {'1': 'profileDialogBg', '3': 1002, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'profileDialogBg'},
    {'1': 'profileDialogBgBack', '3': 1003, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'profileDialogBgBack'},
  ],
};

/// Descriptor for `PayGrade`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payGradeDescriptor = $convert.base64Decode(
    'CghQYXlHcmFkZRIsChF0b3RhbERpYW1vbmRDb3VudBgBIAEoA1IRdG90YWxEaWFtb25kQ291bn'
    'QSLwoLZGlhbW9uZEljb24YAiABKAsyDS5kb3V5aW4uSW1hZ2VSC2RpYW1vbmRJY29uEhIKBG5h'
    'bWUYAyABKAlSBG5hbWUSIQoEaWNvbhgEIAEoCzINLmRvdXlpbi5JbWFnZVIEaWNvbhIaCghuZX'
    'h0TmFtZRgFIAEoCVIIbmV4dE5hbWUSFAoFbGV2ZWwYBiABKANSBWxldmVsEikKCG5leHRJY29u'
    'GAcgASgLMg0uZG91eWluLkltYWdlUghuZXh0SWNvbhIgCgtuZXh0RGlhbW9uZBgIIAEoA1ILbm'
    'V4dERpYW1vbmQSHgoKbm93RGlhbW9uZBgJIAEoA1IKbm93RGlhbW9uZBIwChN0aGlzR3JhZGVN'
    'aW5EaWFtb25kGAogASgDUhN0aGlzR3JhZGVNaW5EaWFtb25kEjAKE3RoaXNHcmFkZU1heERpYW'
    '1vbmQYCyABKANSE3RoaXNHcmFkZU1heERpYW1vbmQSJAoNcGF5RGlhbW9uZEJhaxgMIAEoA1IN'
    'cGF5RGlhbW9uZEJhaxIkCg1ncmFkZURlc2NyaWJlGA0gASgJUg1ncmFkZURlc2NyaWJlEjcKDW'
    'dyYWRlSWNvbkxpc3QYDiADKAsyES5kb3V5aW4uR3JhZGVJY29uUg1ncmFkZUljb25MaXN0EiYK'
    'DnNjcmVlbkNoYXRUeXBlGA8gASgDUg5zY3JlZW5DaGF0VHlwZRIlCgZpbUljb24YECABKAsyDS'
    '5kb3V5aW4uSW1hZ2VSBmltSWNvbhI3Cg9pbUljb25XaXRoTGV2ZWwYESABKAsyDS5kb3V5aW4u'
    'SW1hZ2VSD2ltSWNvbldpdGhMZXZlbBIpCghsaXZlSWNvbhgSIAEoCzINLmRvdXlpbi5JbWFnZV'
    'IIbGl2ZUljb24SPQoSbmV3SW1JY29uV2l0aExldmVsGBMgASgLMg0uZG91eWluLkltYWdlUhJu'
    'ZXdJbUljb25XaXRoTGV2ZWwSLwoLbmV3TGl2ZUljb24YFCABKAsyDS5kb3V5aW4uSW1hZ2VSC2'
    '5ld0xpdmVJY29uEi4KEnVwZ3JhZGVOZWVkQ29uc3VtZRgVIAEoA1ISdXBncmFkZU5lZWRDb25z'
    'dW1lEiYKDm5leHRQcml2aWxlZ2VzGBYgASgJUg5uZXh0UHJpdmlsZWdlcxItCgpiYWNrZ3JvdW'
    '5kGBcgASgLMg0uZG91eWluLkltYWdlUgpiYWNrZ3JvdW5kEjUKDmJhY2tncm91bmRCYWNrGBgg'
    'ASgLMg0uZG91eWluLkltYWdlUg5iYWNrZ3JvdW5kQmFjaxIUCgVzY29yZRgZIAEoA1IFc2Nvcm'
    'USMQoIYnVmZkluZm8YGiABKAsyFS5kb3V5aW4uR3JhZGVCdWZmSW5mb1IIYnVmZkluZm8SIQoL'
    'Z3JhZGVCYW5uZXIY6QcgASgJUgtncmFkZUJhbm5lchI4Cg9wcm9maWxlRGlhbG9nQmcY6gcgAS'
    'gLMg0uZG91eWluLkltYWdlUg9wcm9maWxlRGlhbG9nQmcSQAoTcHJvZmlsZURpYWxvZ0JnQmFj'
    'axjrByABKAsyDS5kb3V5aW4uSW1hZ2VSE3Byb2ZpbGVEaWFsb2dCZ0JhY2s=');

@$core.Deprecated('Use fansClubDescriptor instead')
const FansClub$json = {
  '1': 'FansClub',
  '2': [
    {'1': 'data', '3': 1, '4': 1, '5': 11, '6': '.douyin.FansClubData', '10': 'data'},
    {'1': 'preferData', '3': 2, '4': 3, '5': 11, '6': '.douyin.FansClub.PreferDataEntry', '10': 'preferData'},
  ],
  '3': [FansClub_PreferDataEntry$json],
};

@$core.Deprecated('Use fansClubDescriptor instead')
const FansClub_PreferDataEntry$json = {
  '1': 'PreferDataEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 5, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.douyin.FansClubData', '10': 'value'},
  ],
  '7': {'7': true},
};

/// Descriptor for `FansClub`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fansClubDescriptor = $convert.base64Decode(
    'CghGYW5zQ2x1YhIoCgRkYXRhGAEgASgLMhQuZG91eWluLkZhbnNDbHViRGF0YVIEZGF0YRJACg'
    'pwcmVmZXJEYXRhGAIgAygLMiAuZG91eWluLkZhbnNDbHViLlByZWZlckRhdGFFbnRyeVIKcHJl'
    'ZmVyRGF0YRpTCg9QcmVmZXJEYXRhRW50cnkSEAoDa2V5GAEgASgFUgNrZXkSKgoFdmFsdWUYAi'
    'ABKAsyFC5kb3V5aW4uRmFuc0NsdWJEYXRhUgV2YWx1ZToCOAE=');

@$core.Deprecated('Use fansClubDataDescriptor instead')
const FansClubData$json = {
  '1': 'FansClubData',
  '2': [
    {'1': 'clubName', '3': 1, '4': 1, '5': 9, '10': 'clubName'},
    {'1': 'level', '3': 2, '4': 1, '5': 5, '10': 'level'},
    {'1': 'userFansClubStatus', '3': 3, '4': 1, '5': 5, '10': 'userFansClubStatus'},
    {'1': 'badge', '3': 4, '4': 1, '5': 11, '6': '.douyin.UserBadge', '10': 'badge'},
    {'1': 'availableGiftIds', '3': 5, '4': 3, '5': 3, '10': 'availableGiftIds'},
    {'1': 'anchorId', '3': 6, '4': 1, '5': 3, '10': 'anchorId'},
  ],
};

/// Descriptor for `FansClubData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fansClubDataDescriptor = $convert.base64Decode(
    'CgxGYW5zQ2x1YkRhdGESGgoIY2x1Yk5hbWUYASABKAlSCGNsdWJOYW1lEhQKBWxldmVsGAIgAS'
    'gFUgVsZXZlbBIuChJ1c2VyRmFuc0NsdWJTdGF0dXMYAyABKAVSEnVzZXJGYW5zQ2x1YlN0YXR1'
    'cxInCgViYWRnZRgEIAEoCzIRLmRvdXlpbi5Vc2VyQmFkZ2VSBWJhZGdlEioKEGF2YWlsYWJsZU'
    'dpZnRJZHMYBSADKANSEGF2YWlsYWJsZUdpZnRJZHMSGgoIYW5jaG9ySWQYBiABKANSCGFuY2hv'
    'cklk');
...
const UserBadge$json = {
  '1': 'UserBadge',
  '2': [
    {'1': 'icons', '3': 1, '4': 3, '5': 11, '6': '.douyin.UserBadge.IconsEntry', '10': 'icons'},
    {'1': 'title', '3': 2, '4': 1, '5': 9, '10': 'title'},
  ],
  '3': [UserBadge_IconsEntry$json],
};

@$core.Deprecated('Use userBadgeDescriptor instead')
const UserBadge_IconsEntry$json = {
  '1': 'IconsEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 5, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'value'},
  ],
  '7': {'7': true},
};
...
final $typed_data.Uint8List userBadgeDescriptor = $convert.base64Decode(
    'CglVc2VyQmFkZ2USMgoFaWNvbnMYASADKAsyHC5kb3V5aW4uVXNlckJhZGdlLkljb25zRW50cn'
    'lSBWljb25zEhQKBXRpdGxlGAIgASgJUgV0aXRsZRpHCgpJY29uc0VudHJ5EhAKA2tleRgBIAEo'
    'BVIDa2V5EiMKBXZhbHVlGAIgASgLMg0uZG91eWluLkltYWdlUgV2YWx1ZToCOAE=');

@$core.Deprecated('Use gradeBuffInfoDescriptor instead')
const GradeBuffInfo$json = {
  '1': 'GradeBuffInfo',
};

/// Descriptor for `GradeBuffInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gradeBuffInfoDescriptor = $convert.base64Decode(
    'Cg1HcmFkZUJ1ZmZJbmZv');
...
@$core.Deprecated('Use gradeIconDescriptor instead')
const GradeIcon$json = {
  '1': 'GradeIcon',
  '2': [
    {'1': 'icon', '3': 1, '4': 1, '5': 11, '6': '.douyin.Image', '10': 'icon'},
...
/// Descriptor for `GradeIcon`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gradeIconDescriptor = $convert.base64Decode(
    'CglHcmFkZUljb24SIQoEaWNvbhgBIAEoCzINLmRvdXlpbi5JbWFnZVIEaWNvbhIgCgtpY29uRG'
    'lhbW9uZBgCIAEoA1ILaWNvbkRpYW1vbmQSFAoFbGV2ZWwYAyABKANSBWxldmVsEhoKCGxldmVs'
    'U3RyGAQgASgJUghsZXZlbFN0cg==');
...
@$core.Deprecated('Use liveShoppingMessageDescriptor instead')
const LiveShoppingMessage$json = {
  '1': 'LiveShoppingMessage',
  '2': [
    {'1': 'common', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'common'},
    {'1': 'msgType', '3': 2, '4': 1, '5': 5, '10': 'msgType'},
    {'1': 'promotionId', '3': 4, '4': 1, '5': 3, '10': 'promotionId'},
  ],
};

/// Descriptor for `LiveShoppingMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List liveShoppingMessageDescriptor = $convert.base64Decode(
    'ChNMaXZlU2hvcHBpbmdNZXNzYWdlEiYKBmNvbW1vbhgBIAEoCzIOLmRvdXlpbi5Db21tb25SBm'
    'NvbW1vbhIYCgdtc2dUeXBlGAIgASgFUgdtc2dUeXBlEiAKC3Byb21vdGlvbklkGAQgASgDUgtw'
    'cm9tb3Rpb25JZA==');

@$core.Deprecated('Use roomStatsMessageDescriptor instead')
const RoomStatsMessage$json = {
  '1': 'RoomStatsMessage',
  '2': [
    {'1': 'common', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'common'},
    {'1': 'displayShort', '3': 2, '4': 1, '5': 9, '10': 'displayShort'},
    {'1': 'displayMiddle', '3': 3, '4': 1, '5': 9, '10': 'displayMiddle'},
    {'1': 'displayLong', '3': 4, '4': 1, '5': 9, '10': 'displayLong'},
    {'1': 'displayValue', '3': 5, '4': 1, '5': 3, '10': 'displayValue'},
    {'1': 'displayVersion', '3': 6, '4': 1, '5': 3, '10': 'displayVersion'},
    {'1': 'incremental', '3': 7, '4': 1, '5': 8, '10': 'incremental'},
    {'1': 'isHidden', '3': 8, '4': 1, '5': 8, '10': 'isHidden'},
    {'1': 'total', '3': 9, '4': 1, '5': 3, '10': 'total'},
    {'1': 'displayType', '3': 10, '4': 1, '5': 3, '10': 'displayType'},
  ],
};

/// Descriptor for `RoomStatsMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomStatsMessageDescriptor = $convert.base64Decode(
    'ChBSb29tU3RhdHNNZXNzYWdlEiYKBmNvbW1vbhgBIAEoCzIOLmRvdXlpbi5Db21tb25SBmNvbW'
    '1vbhIiCgxkaXNwbGF5U2hvcnQYAiABKAlSDGRpc3BsYXlTaG9ydBIkCg1kaXNwbGF5TWlkZGxl'
    'GAMgASgJUg1kaXNwbGF5TWlkZGxlEiAKC2Rpc3BsYXlMb25nGAQgASgJUgtkaXNwbGF5TG9uZx'
    'IiCgxkaXNwbGF5VmFsdWUYBSABKANSDGRpc3BsYXlWYWx1ZRImCg5kaXNwbGF5VmVyc2lvbhgG'
    'IAEoA1IOZGlzcGxheVZlcnNpb24SIAoLaW5jcmVtZW50YWwYByABKAhSC2luY3JlbWVudGFsEh'
    'oKCGlzSGlkZGVuGAggASgIUghpc0hpZGRlbhIUCgV0b3RhbBgJIAEoA1IFdG90YWwSIAoLZGlz'
    'cGxheVR5cGUYCiABKANSC2Rpc3BsYXlUeXBl');

@$core.Deprecated('Use productInfoDescriptor instead')
const ProductInfo$json = {
  '1': 'ProductInfo',
  '2': [
    {'1': 'promotionId', '3': 1, '4': 1, '5': 3, '10': 'promotionId'},
    {'1': 'index', '3': 2, '4': 1, '5': 5, '10': 'index'},
    {'1': 'targetFlashUidsList', '3': 3, '4': 3, '5': 3, '10': 'targetFlashUidsList'},
    {'1': 'explainType', '3': 4, '4': 1, '5': 3, '10': 'explainType'},
  ],
};
...
final $typed_data.Uint8List productInfoDescriptor = $convert.base64Decode(
    'CgtQcm9kdWN0SW5mbxIgCgtwcm9tb3Rpb25JZBgBIAEoA1ILcHJvbW90aW9uSWQSFAoFaW5kZX'
    'gYAiABKAVSBWluZGV4EjAKE3RhcmdldEZsYXNoVWlkc0xpc3QYAyADKANSE3RhcmdldEZsYXNo'
    'VWlkc0xpc3QSIAoLZXhwbGFpblR5cGUYBCABKANSC2V4cGxhaW5UeXBl');
...
const CategoryInfo$json = {
  ...
  '2': [
    ...
    {'1': 'promotionIdsList', '3': 3, '4': 3, '5': 3, '10': 'promotionIdsList'},
    {'1': 'type', '3': 4, '4': 1, '5': 9, '10': 'type'},
    {'1': 'uniqueIndex', '3': 5, '4': 1, '5': 9, '10': 'uniqueIndex'},
  ],
};
...
final $typed_data.Uint8List categoryInfoDescriptor = $convert.base64Decode(
    'CgxDYXRlZ29yeUluZm8SDgoCaWQYASABKAVSAmlkEhIKBG5hbWUYAiABKAlSBG5hbWUSKgoQcH'
    'JvbW90aW9uSWRzTGlzdBgDIAMoA1IQcHJvbW90aW9uSWRzTGlzdBISCgR0eXBlGAQgASgJUgR0'
    'eXBlEiAKC3VuaXF1ZUluZGV4GAUgASgJUgt1bmlxdWVJbmRleA==');

@$core.Deprecated('Use productChangeMessageDescriptor instead')
const ProductChangeMessage$json = {
  '1': 'ProductChangeMessage',
  '2': [
    {'1': 'common', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'common'},
    {'1': 'updateTimestamp', '3': 2, '4': 1, '5': 3, '10': 'updateTimestamp'},
    {'1': 'updateToast', '3': 3, '4': 1, '5': 9, '10': 'updateToast'},
    {'1': 'updateProductInfoList', '3': 4, '4': 3, '5': 11, '6': '.douyin.ProductInfo', '10': 'updateProductInfoList'},
    {'1': 'total', '3': 5, '4': 1, '5': 3, '10': 'total'},
    {'1': 'updateCategoryInfoList', '3': 8, '4': 3, '5': 11, '6': '.douyin.CategoryInfo', '10': 'updateCategoryInfoList'},
  ],
};

/// Descriptor for `ProductChangeMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List productChangeMessageDescriptor = $convert.base64Decode(
    'ChRQcm9kdWN0Q2hhbmdlTWVzc2FnZRImCgZjb21tb24YASABKAsyDi5kb3V5aW4uQ29tbW9uUg'
    'Zjb21tb24SKAoPdXBkYXRlVGltZXN0YW1wGAIgASgDUg91cGRhdGVUaW1lc3RhbXASIAoLdXBk'
    'YXRlVG9hc3QYAyABKAlSC3VwZGF0ZVRvYXN0EkkKFXVwZGF0ZVByb2R1Y3RJbmZvTGlzdBgEIA'
    'MoCzITLmRvdXlpbi5Qcm9kdWN0SW5mb1IVdXBkYXRlUHJvZHVjdEluZm9MaXN0EhQKBXRvdGFs'
    'GAUgASgDUgV0b3RhbBJMChZ1cGRhdGVDYXRlZ29yeUluZm9MaXN0GAggAygLMhQuZG91eWluLk'
    'NhdGVnb3J5SW5mb1IWdXBkYXRlQ2F0ZWdvcnlJbmZvTGlzdA==');
...
final $typed_data.Uint8List controlMessageDescriptor = $convert.base64Decode(
    'Cg5Db250cm9sTWVzc2FnZRImCgZjb21tb24YASABKAsyDi5kb3V5aW4uQ29tbW9uUgZjb21tb2'
    '4SFgoGc3RhdHVzGAIgASgFUgZzdGF0dXM=');

@$core.Deprecated('Use fansclubMessageDescriptor instead')
const FansclubMessage$json = {
  '1': 'FansclubMessage',
  '2': [
    {'1': 'commonInfo', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'commonInfo'},
    {'1': 'type', '3': 2, '4': 1, '5': 5, '10': 'type'},
    {'1': 'content', '3': 3, '4': 1, '5': 9, '10': 'content'},
    {'1': 'user', '3': 4, '4': 1, '5': 11, '6': '.douyin.User', '10': 'user'},
  ],
};

/// Descriptor for `FansclubMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fansclubMessageDescriptor = $convert.base64Decode(
    'Cg9GYW5zY2x1Yk1lc3NhZ2USLgoKY29tbW9uSW5mbxgBIAEoCzIOLmRvdXlpbi5Db21tb25SCm'
    'NvbW1vbkluZm8SEgoEdHlwZRgCIAEoBVIEdHlwZRIYCgdjb250ZW50GAMgASgJUgdjb250ZW50'
    'EiAKBHVzZXIYBCABKAsyDC5kb3V5aW4uVXNlclIEdXNlcg==');

@$core.Deprecated('Use roomRankMessageDescriptor instead')
const RoomRankMessage$json = {
  '1': 'RoomRankMessage',
  '2': [
    {'1': 'common', '3': 1, '4': 1, '5': 11, '6': '.douyin.Common', '10': 'common'},
    {'1': 'ranksList', '3': 2, '4': 3, '5': 11, '6': '.douyin.RoomRankMessage.RoomRank', '10': 'ranksList'},
  ],
  '3': [RoomRankMessage_RoomRank$json],
};

@$core.Deprecated('Use roomRankMessageDescriptor instead')
const RoomRankMessage_RoomRank$json = {
  '1': 'RoomRank',
  '2': [
    {'1': 'user', '3': 1, '4': 1, '5': 11, '6': '.douyin.User', '10': 'user'},
    {'1': 'scoreStr', '3': 2, '4': 1, '5': 9, '10': 'scoreStr'},
    {'1': 'profileHidden', '3': 3, '4': 1, '5': 8, '10': 'profileHidden'},
  ],
};

/// Descriptor for `RoomRankMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomRankMessageDescriptor = $convert.base64Decode(
    'Cg9Sb29tUmFua01lc3NhZ2USJgoGY29tbW9uGAEgASgLMg4uZG91eWluLkNvbW1vblIGY29tbW'
    '9uEj4KCXJhbmtzTGlzdBgCIAMoCzIgLmRvdXlpbi5Sb29tUmFua01lc3NhZ2UuUm9vbVJhbmtS'
    'CXJhbmtzTGlzdBpuCghSb29tUmFuaxIgCgR1c2VyGAEgASgLMgwuZG91eWluLlVzZXJSBHVzZX'
    'ISGgoIc2NvcmVTdHIYAiABKAlSCHNjb3JlU3RyEiQKDXByb2ZpbGVIaWRkZW4YAyABKAhSDXBy'
    'b2ZpbGVIaWRkZW4=');
...
const RoomMessage$json = {
  ...
  '2': [
    ...
    {'1': 'supprotLandscape', '3': 3, '4': 1, '5': 8, '10': 'supprotLandscape'},
    {'1': 'roommessagetype', '3': 4, '4': 1, '5': 14, '6': '.douyin.RoomMsgTypeEnum', '10': 'roommessagetype'},
    {'1': 'systemTopMsg', '3': 5, '4': 1, '5': 8, '10': 'systemTopMsg'},
    {'1': 'forcedGuarantee', '3': 6, '4': 1, '5': 8, '10': 'forcedGuarantee'},
    {'1': 'bizScene', '3': 20, '4': 1, '5': 9, '10': 'bizScene'},
    {'1': 'buriedPointMap', '3': 30, '4': 3, '5': 11, '6': '.douyin.RoomMessage.BuriedPointMapEntry', '10': 'buriedPointMap'},
  ],
  '3': [RoomMessage_BuriedPointMapEntry$json],
};

@$core.Deprecated('Use roomMessageDescriptor instead')
const RoomMessage_BuriedPointMapEntry$json = {
  '1': 'BuriedPointMapEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 9, '10': 'value'},
  ],
...
final $typed_data.Uint8List roomMessageDescriptor = $convert.base64Decode(
    'CgtSb29tTWVzc2FnZRImCgZjb21tb24YASABKAsyDi5kb3V5aW4uQ29tbW9uUgZjb21tb24SGA'
    'oHY29udGVudBgCIAEoCVIHY29udGVudBIqChBzdXBwcm90TGFuZHNjYXBlGAMgASgIUhBzdXBw'
    'cm90TGFuZHNjYXBlEkEKD3Jvb21tZXNzYWdldHlwZRgEIAEoDjIXLmRvdXlpbi5Sb29tTXNnVH'
    'lwZUVudW1SD3Jvb21tZXNzYWdldHlwZRIiCgxzeXN0ZW1Ub3BNc2cYBSABKAhSDHN5c3RlbVRv'
    'cE1zZxIoCg9mb3JjZWRHdWFyYW50ZWUYBiABKAhSD2ZvcmNlZEd1YXJhbnRlZRIaCghiaXpTY2'
    'VuZRgUIAEoCVIIYml6U2NlbmUSTwoOYnVyaWVkUG9pbnRNYXAYHiADKAsyJy5kb3V5aW4uUm9v'
    'bU1lc3NhZ2UuQnVyaWVkUG9pbnRNYXBFbnRyeVIOYnVyaWVkUG9pbnRNYXAaQQoTQnVyaWVkUG'
    '9pbnRNYXBFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWU6AjgB');
